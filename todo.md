- # todo: bug: first look up something with "+" etc., so that it has a comment, then use "..c", then copy will also copy the comment >> just save the last comment and answer separately!
